...
import { CancellationService } from 'src/app/Cancellations/Services/cancellation.service';
import { of } from 'rxjs';
...
actualNoOfSeats : number;
  ...
  constructor(private bookingsService: BookingDataService, private router: Router, @Inject(DOCUMENT) private document: Document,
    ...
    this.updateForm = new FormGroup({
      ...
      Source: new FormControl(`${(this.route.snapshot.params.sor)}`, [Validators.required]),
      Destination: new FormControl(`${(this.route.snapshot.params.des)}`, [Validators.required]),
      ...
      TicketStatus: new FormControl("NOTC"),
